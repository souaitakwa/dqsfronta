...
@Component({
  selector: 'app-clientreportdetails',
  templateUrl: './clientreportdetails.component.html',
  styleUrls: ['./clientreportdetails.component.css']
})
export class ClientreportdetailsComponent implements OnInit {
...
ngOnInit() {
  ...
  fetchAll(): Observable<comment[]> {
    return this.commentService.fetchAll(62);
  }
}
